...
class Detailspage extends React.Component {
    ...
    moveas(e) { 
        ...
        let lef = this.refs.dbox.offsetLeft;
        let tp = this.refs.dbox.offsetTop;
         // 获取遮盖部分的left和top值
        let left = e.clientX - lef - this.refs.move.offsetWidth / 2;
        let top = e.clientY - tp - this.refs.move.offsetHeight / 2;
        ...
        if (top < 0) {
            top = 0;
        } else if (top >= this.refs.dbox.offsetHeight - this.refs.move.offsetHeight) {
            top = this.refs.dbox.offsetHeight - this.refs.move.offsetHeight
        }
            ...
            <div className='box'>
                <div className="nch-breadcrumb-layout">
                    <div className="nch-breadcrumb wrapper"><i className="icon-home"></i>
                        ...
                        <span>春季2018新款马甲韩版棉衣背心男士修身棉服潮流冬季羽绒马夹外套 黑色 M</span>
                    </div>
                </div>
                        ...
                        <div id="ncs-goods-picture" className="ncs-goods-picture">
                            <div className="gallery_wrap" >
                                <div className="gallery" ref='dbox'>
                                    ...
                                    <div className="move" onMouseOut={this.display_none.bind(this)}  onMouseOver={this.display_name.bind(this)}  onMouseMove={this.moveas.bind(this)} style={{ display: this.state.disp, left:this.state.left , top:this.state.top,zIndex:'99999' }} ref="move"></div>
                                </div>
                            </div>
